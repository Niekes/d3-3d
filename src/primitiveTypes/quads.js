...
export function quads(data, options, point, angles){
    ...
    for (var i = data.length - 1; i >= 0; i--) {
        ...
        quad.centroid = { x: (p1.rotated.x + p2.rotated.x + p3.rotated.x + p4.rotated.x)/4, y: (p1.rotated.y + p2.rotated.y + p3.rotated.y + p4.rotated.y)/4, z: (p1.rotated.z + p2.rotated.z + p3.rotated.z + p4.rotated.z)/4};
    }
    return data;
}
